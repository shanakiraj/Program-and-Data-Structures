 ...
 * @author Shan Akiraj
 * @date 11/29/21
 * @brief This function shuffles an array of strings.
 * 
 * @return void
 * @param first The iterator at the beginning of the vector
 * @param last The iterator at the end of the vector
 * @param g The address of  mt19937, Mersenne-Twister random number engine
 */
...
/**
 * @brief Creates a an array of size 40, and stores the names
 * of the human towns, cities and strongholds inside it
 */
 ...
 * @author Shan Akiraj
 * @date 11/29/21
 * @brief This creates the MiddleEarth
 * @return void
...
/**
 * @details This is the  print method for MiddleEarth. Prints the 
 * city name as well as their x and y positions and size
 * @author Shan Akiraj
 * @date 11/29/21
 ...
 * @param city1 the address of city1
 * @param city2 the address of city2
 */
